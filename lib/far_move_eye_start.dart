...
class FarMoveEyeStart extends StatefulWidget {
  const FarMoveEyeStart({Key? key}) : super(key: key);

  @override
  State<FarMoveEyeStart> createState() => _FarMoveEyeStartState();
}

class _FarMoveEyeStartState extends State<FarMoveEyeStart> {
  @override
