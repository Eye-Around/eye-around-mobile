...
class FarMoveEyeZeroStart extends StatefulWidget {
  const FarMoveEyeZeroStart({Key? key}) : super(key: key);

  @override
  State<FarMoveEyeZeroStart> createState() => _FarMoveEyeZeroStartState();
}

class _FarMoveEyeZeroStartState extends State<FarMoveEyeZeroStart> {
  @override
            ...
            PositionedTransition(
              rect: RelativeRectTween(
                begin: RelativeRect.fromSize(
                    const Rect.fromLTWH(0.0, 400.0, 100.0, 100.0),
                    biggest
                ),
                end: RelativeRect.fromSize(
                  Rect.fromLTWH(biggest.width - 100.0, 0.0, 100.0, 100.0),
                  biggest,
                ),
